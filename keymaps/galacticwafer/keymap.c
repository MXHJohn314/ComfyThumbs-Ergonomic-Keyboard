...
[_QWERTY] = LAYOUT_ortho_7x7 (
    ...
    KC_TAB,  KC_W,    KC_L,    KC_R,    KC_B,   KC_Z,     KC_LBRC,  /**/   KC_RBRC, KC_SCLN, KC_Q,    KC_U,    KC_D,    KC_J,    KC_SLCK,
             KC_S,    KC_H,    KC_N,    KC_T,   KC_COMM,  KC_INS,   /**/   KC_BSLS, KC_DOT,  KC_A,    KC_E,    KC_O,    KC_I,    KC_QUOT,
...
[1] = LAYOUT_ortho_7x7 (
    ...
    _______, _______, _______, _______,            QWERT, _______,  /**/   _______,   QWERT, _______,                   _______,
    _______, _______, _______, _______, _______, _______, _______,  /**/   _______, _______, _______, _______, _______, _______, _______
),
...
[_QWERTY] = LAYOUT_ortho_7x7 (
    ...
    KC_CAPS, KC_APP,  KC_PAUS, KC_LSFT,         KC_BSPC,  KC_LCTL,  /**/   KC_RCTL, KC_SPC,  KC_RSFT,                   KC_ENT,
    MO(3),  KC_HOME,  KC_PGUP, KC_PGDN, KC_END, KC_LGUI,  KC_LALT,  /**/   KC_RALT, KC_RGUI, KC_LEFT, KC_UP,   KC_DOWN, KC_RIGHT, MO(3)
),
...
[1] = LAYOUT_ortho_7x7 (
    ...
    _______, _______, _______, _______, _______, _______, _______,  /**/   _______, _______, _______, _______, _______, _______, _______,
             _______, _______, _______, _______, _______, _______,  /**/   _______, _______, _______, _______, _______, _______, _______,
             _______, _______, _______, _______, _______,           /**/            _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______,            HALMK, _______,  /**/   _______,   HALMK, _______,                   _______,
    _______, _______, _______, _______, _______, _______, _______,  /**/   _______, _______, _______, _______, _______, _______, _______
),
};
