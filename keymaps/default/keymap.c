...
[_QWERTY] = ortho_7x7 (
    ...
    KC_SLCK, KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,     KC_TAB,   /**/   KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_SLCK,
    KC_INS,  KC_A,    KC_S,    KC_D,    KC_F,   KC_G,     KC_LBRC,  /**/   KC_BSLS, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_CAPS, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,               /**/            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_NLCK,
